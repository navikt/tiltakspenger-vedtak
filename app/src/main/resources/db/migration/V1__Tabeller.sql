...
(
    ...
    sist_endret TIMESTAMP(6) WITH TIME ZONE NOT NULL,
...
(
    ...
    opprettet           TIMESTAMP(6) WITH TIME ZONE NULL,
    tidsstempel_hos_oss TIMESTAMP(6) WITH TIME ZONE NOT NULL
);
...
(
    ...
    tidsstempel_hos_oss    TIMESTAMP(6) WITH TIME ZONE NULL
);
