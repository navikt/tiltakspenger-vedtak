...
class ForeldrepengerVedtakDAO(
        ...
        txSession.run(
            queryOf(
                ...
                mapOf(
                    ...
                    "ytelse" to foreldrepengerVedtak.ytelse,
                    "saksnummer" to foreldrepengerVedtak.saksnummer,
                    "vedtakReferanse" to foreldrepengerVedtak.vedtakReferanse,
                    "ytelseStatus" to foreldrepengerVedtak.ytelseStatus,
                    "kildesystem" to foreldrepengerVedtak.kildesystem,
    ...
    private fun Row.toForeldrepengerVedtak(txSession: TransactionalSession): ForeldrepengerVedtak {
        ...
        return ForeldrepengerVedtak(
            ...
            vedtakReferanse = string("vedtak_referanse"),
            ytelseStatus = ForeldrepengerVedtak.Status.valueOf("ytelse_status"),
            kildesystem = ForeldrepengerVedtak.Kildesystem.valueOf("kildesystem"),
