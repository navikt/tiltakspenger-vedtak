...
fun Map<String, Søknad.FraOgMedDatoSpm>.toFraOgMedDatoSpmParams(): Map<String, Any> =
    this.flatMap { (k, v) ->
        listOf(
            k to lagreFraOgMedDatoSpmType(v),
...
fun lagreJaNeiSpmType(jaNeiSpm: Søknad.JaNeiSpm) =
    when (jaNeiSpm) {
