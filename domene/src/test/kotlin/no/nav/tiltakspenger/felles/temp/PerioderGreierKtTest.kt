...
class PerioderGreierKtTest {
    ...
    fun test1() {
        val perioderMedDagsats =
            PeriodeMedVerdier(255L, Periode(1.oktober(2023), 10.oktober(2023)))
                .setDelPeriodeMedVerdi(300L, Periode(1.oktober(2023), 1.oktober(2023)))
                .setDelPeriodeMedVerdi(300L, Periode(2.oktober(2023), 2.oktober(2023)))
                .setDelPeriodeMedVerdi(300L, Periode(3.oktober(2023), 3.oktober(2023)))
                .setDelPeriodeMedVerdi(300L, Periode(4.oktober(2023), 4.oktober(2023)))
                .setDelPeriodeMedVerdi(300L, Periode(5.oktober(2023), 5.oktober(2023)))
                .setDelPeriodeMedVerdi(300L, Periode(6.oktober(2023), 6.oktober(2023)))
                .setDelPeriodeMedVerdi(300L, Periode(7.oktober(2023), 7.oktober(2023)))
                .setDelPeriodeMedVerdi(300L, Periode(8.oktober(2023), 8.oktober(2023)))
                .setDelPeriodeMedVerdi(300L, Periode(9.oktober(2023), 9.oktober(2023)))
                .setDelPeriodeMedVerdi(300L, Periode(10.oktober(2023), 10.oktober(2023)))
    ...
    fun test2() {
        val perioderMedDagsats =
            PeriodeMedVerdier(255L, Periode(1.oktober(2023), 10.oktober(2023)))
                .setDelPeriodeMedVerdi(300L, Periode(1.oktober(2023), 1.oktober(2023)))
                .setDelPeriodeMedVerdi(301L, Periode(2.oktober(2023), 2.oktober(2023)))
                .setDelPeriodeMedVerdi(300L, Periode(3.oktober(2023), 3.oktober(2023)))
                .setDelPeriodeMedVerdi(301L, Periode(4.oktober(2023), 4.oktober(2023)))
                .setDelPeriodeMedVerdi(300L, Periode(5.oktober(2023), 5.oktober(2023)))
                .setDelPeriodeMedVerdi(301L, Periode(6.oktober(2023), 6.oktober(2023)))
                .setDelPeriodeMedVerdi(300L, Periode(7.oktober(2023), 7.oktober(2023)))
                .setDelPeriodeMedVerdi(301L, Periode(8.oktober(2023), 8.oktober(2023)))
                .setDelPeriodeMedVerdi(300L, Periode(9.oktober(2023), 9.oktober(2023)))
                .setDelPeriodeMedVerdi(301L, Periode(10.oktober(2023), 10.oktober(2023)))
    ...
    fun test3() {
        val perioderMedDagsats =
            PeriodeMedVerdier(255L, Periode(1.oktober(2023), 10.oktober(2023)))
                .setDelPeriodeMedVerdi(300L, Periode(1.oktober(2023), 1.oktober(2023)))
                .setDelPeriodeMedVerdi(300L, Periode(2.oktober(2023), 2.oktober(2023)))
                .setDelPeriodeMedVerdi(301L, Periode(3.oktober(2023), 3.oktober(2023)))
                .setDelPeriodeMedVerdi(301L, Periode(4.oktober(2023), 4.oktober(2023)))
                .setDelPeriodeMedVerdi(300L, Periode(5.oktober(2023), 5.oktober(2023)))
                .setDelPeriodeMedVerdi(300L, Periode(6.oktober(2023), 6.oktober(2023)))
                .setDelPeriodeMedVerdi(301L, Periode(7.oktober(2023), 7.oktober(2023)))
                .setDelPeriodeMedVerdi(301L, Periode(8.oktober(2023), 8.oktober(2023)))
                .setDelPeriodeMedVerdi(300L, Periode(9.oktober(2023), 9.oktober(2023)))
                .setDelPeriodeMedVerdi(300L, Periode(10.oktober(2023), 10.oktober(2023)))
    ...
    fun test4() {
        ...
        val perioderMedAntallBarn =
            PeriodeMedVerdier(0, Periode(1.oktober(2023), 4.oktober(2023)))
                .setDelPeriodeMedVerdi(1, Periode(1.oktober(2023), 1.oktober(2023)))
                .setDelPeriodeMedVerdi(2, Periode(2.oktober(2023), 2.oktober(2023)))
                .setDelPeriodeMedVerdi(2, Periode(3.oktober(2023), 3.oktober(2023)))
                .setDelPeriodeMedVerdi(1, Periode(4.oktober(2023), 4.oktober(2023)))
