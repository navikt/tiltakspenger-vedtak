...
internal class PeriodeTest {
    ...
    fun intersect() {
        ...
        assertEquals(periode1, periode1.intersect(periode1))
        assertEquals(fellesperiode, periode1.intersect(periode2))
        assertEquals(fellesperiode, periode2.intersect(periode1))
        assertNotEquals(fellesperiode, periode2.intersect(periode2))
    }
