...
import no.nav.tiltakspenger.innsending.helper.DirtyCheckingAktivitetslogg
...
import no.nav.tiltakspenger.saksbehandling.personopplysninger.barnUtenIdent
...
class Innsending private constructor(
    ...
    private fun trengerPersonopplysninger(hendelse: InnsendingHendelse) {
        hendelse.behov(
            type = Aktivitet.Behov.Behovtype.personopplysninger,
    ...
    private fun trengerSkjermingdata(hendelse: InnsendingHendelse) {
        hendelse.behov(
            type = Aktivitet.Behov.Behovtype.skjerming,
    ...
    private fun trengerTiltak(hendelse: InnsendingHendelse) {
        hendelse.behov(
            type = Aktivitet.Behov.Behovtype.tiltak,
    ...
    private fun trengerArenaYtelse(hendelse: InnsendingHendelse) {
        hendelse.behov(
            type = Aktivitet.Behov.Behovtype.arenaytelser,
    ...
    private fun trengerForeldrepenger(hendelse: InnsendingHendelse) {
        hendelse.behov(
            type = Aktivitet.Behov.Behovtype.fpytelser,
    ...
    private fun trengerOvergangsstønad(hendelse: InnsendingHendelse) {
        hendelse.behov(
            type = Aktivitet.Behov.Behovtype.overgangsstønad,
    ...
    private fun trengerUføre(hendelse: InnsendingHendelse) {
        hendelse.behov(
            type = Aktivitet.Behov.Behovtype.uføre,
