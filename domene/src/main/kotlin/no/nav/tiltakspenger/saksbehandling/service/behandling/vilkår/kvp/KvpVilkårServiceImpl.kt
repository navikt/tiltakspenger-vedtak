...
class KvpVilkårServiceImpl(
    ...
    override suspend fun leggTilSaksopplysning(command: LeggTilKvpSaksopplysningCommand): Either<KanIkkeLeggeTilSaksopplysning, Behandling> {
        ...
        val behandling =
            behandlingService.hentBehandling(command.behandlingId, command.saksbehandler, command.correlationId)
