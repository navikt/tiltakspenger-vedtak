...
sealed class Vilkår {
    ...
    abstract val lovReference: List<LovreferanseTilVilkår>
    ...
    object ALDER : Vilkår() {
        ...
        override val lovReference: List<LovreferanseTilVilkår> = listOf(LovreferanseTilVilkår.ALDER)
    }

    object TILTAKSPENGER : Vilkår() {
        override val tittel: String = "TILTAKSPENGER"
        override val flateTittel: String = "Tiltakspenger"
        override val lovReference: List<LovreferanseTilVilkår> = listOf(LovreferanseTilVilkår.TILTAKSPENGER)
    }

    object JOBBSJANSEN : Vilkår() {
        override val tittel: String = "JOBBSJANSEN"
        override val flateTittel: String = "Jobbsjansen"
        override val lovReference: List<LovreferanseTilVilkår> = listOf(LovreferanseTilVilkår.JOBBSJANSEN)
    }

    object AAP : Vilkår() {
        override val tittel: String = "AAP"
        override val flateTittel: String = "AAP"
        override val lovReference: List<LovreferanseTilVilkår> = listOf(LovreferanseTilVilkår.AAP)
    }

    object DAGPENGER : Vilkår() {
        override val tittel: String = "DAGPENGER"
        override val flateTittel: String = "Dagpenger"
        override val lovReference: List<LovreferanseTilVilkår> = listOf(LovreferanseTilVilkår.DAGPENGER)
    }

    object SYKEPENGER : Vilkår() {
        override val tittel: String = "SYKEPENGER"
        override val flateTittel: String = "Sykepenger"
        override val lovReference: List<LovreferanseTilVilkår> = listOf(LovreferanseTilVilkår.SYKEPENGER)
    }

    object UFØRETRYGD : Vilkår() {
        override val tittel: String = "UFØRETRYGD"
        override val flateTittel: String = "Uføretrygd"
        override val lovReference: List<LovreferanseTilVilkår> = listOf(LovreferanseTilVilkår.UFØRETRYGD)
    }

    object OVERGANGSSTØNAD : Vilkår() {
        override val tittel: String = "OVERGANGSSTØNAD"
        override val flateTittel: String = "Overgangsstønad"
        override val lovReference: List<LovreferanseTilVilkår> = listOf(LovreferanseTilVilkår.OVERGANGSSTØNAD)
    }
    ...
    object PLEIEPENGER_NÆRSTÅENDE : Vilkår() {
        ...
        override val lovReference: List<LovreferanseTilVilkår> = listOf(LovreferanseTilVilkår.PLEIEPENGER_NÆRSTÅENDE)
    }
    ...
    object PLEIEPENGER_SYKT_BARN : Vilkår() {
        ...
        override val lovReference: List<LovreferanseTilVilkår> = listOf(LovreferanseTilVilkår.PLEIEPENGER_SYKT_BARN)
    }

    object FORELDREPENGER : Vilkår() {
        override val tittel: String = "FORELDREPENGER"
        override val flateTittel: String = "Foreldrepenger"
        override val lovReference: List<LovreferanseTilVilkår> = listOf(LovreferanseTilVilkår.FORELDREPENGER)
    }
    ...
    object SVANGERSKAPSPENGER : Vilkår() {
        ...
        override val lovReference: List<LovreferanseTilVilkår> = listOf(LovreferanseTilVilkår.SVANGERSKAPSPENGER)
    }
    ...
    object GJENLEVENDEPENSJON : Vilkår() {
        ...
        override val lovReference: List<LovreferanseTilVilkår> = listOf(LovreferanseTilVilkår.GJENLEVENDEPENSJON)
    }
    ...
    object SUPPLERENDESTØNADFLYKTNING : Vilkår() {
        ...
        override val lovReference: List<LovreferanseTilVilkår> = listOf(LovreferanseTilVilkår.SUPPLERENDESTØNAD_FLYKTNING)
    }
    ...
    object SUPPLERENDESTØNADALDER : Vilkår() {
        ...
        override val lovReference: List<LovreferanseTilVilkår> = listOf(LovreferanseTilVilkår.SUPPLERENDESTØNAD_ALDER)
    }

    object ALDERSPENSJON : Vilkår() {
        override val tittel: String = "ALDERSPENSJON"
        override val flateTittel: String = "Alderpensjon"
        override val lovReference: List<LovreferanseTilVilkår> = listOf(LovreferanseTilVilkår.ALDERSPENSJON)
    }
    ...
    object OPPLÆRINGSPENGER : Vilkår() {
        ...
        override val lovReference: List<LovreferanseTilVilkår> = listOf(LovreferanseTilVilkår.OPPLÆRINGSPENGER)
    }

    object OMSORGSPENGER : Vilkår() {
        override val tittel: String = "OMSORGSPENGER"
        override val flateTittel: String = "Omsorgspenger"
        override val lovReference: List<LovreferanseTilVilkår> = listOf(LovreferanseTilVilkår.OMSORGSPENGER)
    }
    ...
    object INTROPROGRAMMET : Vilkår() {
        ...
        override val lovReference: List<LovreferanseTilVilkår> = listOf(LovreferanseTilVilkår.INTROPROGRAMMET)
    }

    object KVP : Vilkår() {
        override val tittel: String = "KVP"
        override val flateTittel: String = "Kvalifiseringsprogrammet(KVP)"
        override val lovReference: List<LovreferanseTilVilkår> = listOf(LovreferanseTilVilkår.KVP)
    }
    ...
    object INSTITUSJONSOPPHOLD : Vilkår() {
        ...
        override val lovReference: List<LovreferanseTilVilkår> = listOf(LovreferanseTilVilkår.INSTITUSJONSOPPHOLD)
    }

    object PENSJONSINNTEKT : Vilkår() {
        override val tittel: String = "PENSJONSINNTEKT"
        override val flateTittel: String = "Pensjonsinntekt"
        override val lovReference: List<LovreferanseTilVilkår> = listOf(LovreferanseTilVilkår.PENSJONSINNTEKT)
    }

    object LØNNSINNTEKT : Vilkår() {
        override val tittel: String = "LØNNSINNTEKT"
        override val flateTittel: String = "Lønnsinntekt"
        override val lovReference: List<LovreferanseTilVilkår> = listOf(LovreferanseTilVilkår.LØNNSINNTEKT)
    }

    object ETTERLØNN : Vilkår() {
        override val tittel: String = "ETTERLØNN"
        override val flateTittel: String = "Etterlønn"
        override val lovReference: List<LovreferanseTilVilkår> =
            listOf(LovreferanseTilVilkår.ETTERLØNNARBEIDSMARKEDSLOV, LovreferanseTilVilkår.ETTERLØNNRUNDSKRIV)
    }
}
